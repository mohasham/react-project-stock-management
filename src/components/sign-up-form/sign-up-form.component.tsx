    ...
    const handleSubmit=async(event:FormEvent<HTMLFormElement>)=>{
        ...
        //    ------------------------  NOTE   --------------
           ...
           //we can do it in the context using a listner if we want
            ...
            //know we get the code of error firectly from firebase
            //so form AuthErrorCodes we can choose the error we want and if we hover over it it is
            //like the string email already in use
