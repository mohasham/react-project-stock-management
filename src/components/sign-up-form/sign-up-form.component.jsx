  ...
  <div className='sign-up-form'>
    ...
    <form onSubmit={handleSubmit}>
      <div className='sign-up-form__field'>
        ...
        />
        {errors.displayName && (
          <p className='sign-up-form__error'>{errors.displayName}</p>
        )}
      </div>
      ...
      <div className='sign-up-form__field'>
        ...
        />
        {errors.email && (
          <p className='sign-up-form__error'>{errors.email}</p>
        )}
      </div>
      ...
      <div className='sign-up-form__field'>
        ...
        />
        {errors.password && (
          <p className='sign-up-form__error'>{errors.password}</p>
        )}
      </div>
      ...
      <div className='sign-up-form__field'>
        ...
        {errors.confirmPassword && (
          <p className='sign-up-form__error'>{errors.confirmPassword}</p>
        )}
      </div>
